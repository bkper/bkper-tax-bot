...
export const ACCOUNT_NAME_ORIGIN_EXP = '${account.name.origin}';
export const ACCOUNT_NAME_DESTINATION_EXP = '${account.name.destination}';
export const ACCOUNT_CONTRA_NAME_EXP = '${account.contra.name}';
